 ...
 * copy_ram_to_sd.asm
 *
 *  Contiene el archivo para guardar la informacion en la SD mediante el protocolo serie
 */ 
...
;Archivo que contiene las funciones para realizar la escritura 
;y lectura de una memoria SD

;A) Inicializar SD
;******************
; Pasos para inicializar una tarjeta SD
; 1)Se debe activar la señal del CLK en 80 ciclos, mientras se
; tiene el conector ~SS en estado alto. Esto último se logra
; poniendo el bit ~SS en 0 del microcontrolador.
; 2) Enviar el comando 0
; 3) Enviar el comando 1 varias veces (no está predefinido).

;Envio de comando para inicializar tarjeta: "cmd0"
...
;CMD24  | [31:0] dilección 	|  R1 	     | Escribir un bloque
